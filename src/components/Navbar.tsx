    ...
    return (
        <nav className="sticky top-0 z-50 bg-white border-b">
            <div className="max-w-7xl flex justify-between items-center mx-auto px-4 py-5">
                ...
                {/* Desktop menu */}
                <div className="hidden items-center gap-5 text-sm font-medium text-gray-500 hover:text-gray-600 md:flex transition">
                    <a href="#">Home</a>
                ...
                {/* Mobile menu */}
                {menuOpen && (
                    <div className="absolute left-0 top-full w-full border-b bg-white px-5 py-5 shadow">
